...
.method public constructor <init>(Ljavax/net/ssl/SSLSocketFactory;[Ljava/lang/String;[Ljava/lang/String;Ljavax/net/ssl/HostnameVerifier;)V
    ...
    iput-object v0, p0, Lorg/apache/http/conn/ssl/SSLConnectionSocketFactory;->log:LoO00OO;
...
.method private verifyHostname(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lorg/apache/http/conn/ssl/SSLConnectionSocketFactory;->log:LoO00OO;
    ...
    iget-object v4, p0, Lorg/apache/http/conn/ssl/SSLConnectionSocketFactory;->log:LoO00OO;
    ...
    :cond_2
    iget-object v3, p0, Lorg/apache/http/conn/ssl/SSLConnectionSocketFactory;->log:LoO00OO;
    ...
    iget-object v5, p0, Lorg/apache/http/conn/ssl/SSLConnectionSocketFactory;->log:LoO00OO;
...
.method public connectSocket(ILjava/net/Socket;Lorg/apache/http/HttpHost;Ljava/net/InetSocketAddress;Ljava/net/InetSocketAddress;Lorg/apache/http/protocol/HttpContext;)Ljava/net/Socket;
    ...
    :cond_2
    iget-object p5, p0, Lorg/apache/http/conn/ssl/SSLConnectionSocketFactory;->log:LoO00OO;

    invoke-interface {p5}, LoO00OO;->O00000Oo()Z
    ...
    invoke-interface {p5, v0}, LoO00OO;->O000000o(Ljava/lang/Object;)V
    ...
    iget-object p4, p0, Lorg/apache/http/conn/ssl/SSLConnectionSocketFactory;->log:LoO00OO;

    const-string p5, "Starting handshake"

    invoke-interface {p4, p5}, LoO00OO;->O000000o(Ljava/lang/Object;)V
...
.method public createLayeredSocket(Ljava/net/Socket;Ljava/lang/String;ILorg/apache/http/protocol/HttpContext;)Ljava/net/Socket;
    ...
    :cond_7
    :goto_3
    iget-object p3, p0, Lorg/apache/http/conn/ssl/SSLConnectionSocketFactory;->log:LoO00OO;
    ...
    invoke-interface {p3, p4}, LoO00OO;->O000000o(Ljava/lang/Object;)V
