...
.method private constructor <init>(Ljava/lang/Runnable;[Ljava/lang/Throwable;Ljava/util/concurrent/Semaphore;)V
    ...
    iput-object p2, p0, Lcom/google/firebase/firestore/util/AsyncQueue$$Lambda$4;->arg$2:[Ljava/lang/Throwable;

    iput-object p3, p0, Lcom/google/firebase/firestore/util/AsyncQueue$$Lambda$4;->arg$3:Ljava/util/concurrent/Semaphore;
...
.method public static lambdaFactory$(Ljava/lang/Runnable;[Ljava/lang/Throwable;Ljava/util/concurrent/Semaphore;)Ljava/lang/Runnable;
    ...
    invoke-direct {v0, p0, p1, p2}, Lcom/google/firebase/firestore/util/AsyncQueue$$Lambda$4;-><init>(Ljava/lang/Runnable;[Ljava/lang/Throwable;Ljava/util/concurrent/Semaphore;)V
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/google/firebase/firestore/util/AsyncQueue$$Lambda$4;->arg$2:[Ljava/lang/Throwable;

    iget-object v2, p0, Lcom/google/firebase/firestore/util/AsyncQueue$$Lambda$4;->arg$3:Ljava/util/concurrent/Semaphore;
