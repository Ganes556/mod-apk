...
.method public static callTask(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)Lcom/google/android/gms/tasks/Task;
    ...
    new-instance v1, Lcom/google/firebase/firestore/util/-$$Lambda$AsyncQueue$jRC7IX3fQiMdusQnZW9E0Dvdffc;

    invoke-direct {v1, p1, p0, v0}, Lcom/google/firebase/firestore/util/-$$Lambda$AsyncQueue$jRC7IX3fQiMdusQnZW9E0Dvdffc;-><init>(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
...
.method static synthetic lambda$callTask$1(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
    ...
    new-instance v1, Lcom/google/firebase/firestore/util/-$$Lambda$AsyncQueue$3y26qaxyqvva-tuz5coBZm3xMBo;

    invoke-direct {v1, p2}, Lcom/google/firebase/firestore/util/-$$Lambda$AsyncQueue$3y26qaxyqvva-tuz5coBZm3xMBo;-><init>(Lcom/google/android/gms/tasks/TaskCompletionSource;)V
...
.method static synthetic lambda$panic$3(Ljava/lang/Throwable;)V
    ...
    const-string v1, "Firestore (23.0.1) ran out of memory. Check your queries to make sure they are not loading an excessive amount of data."
    ...
    const-string v1, "Internal error in Cloud Firestore (23.0.1)."
...
.method public enqueue(Ljava/lang/Runnable;)Lcom/google/android/gms/tasks/Task;
    ...
    .line 434
    new-instance v0, Lcom/google/firebase/firestore/util/-$$Lambda$AsyncQueue$Y9GO7zO2DX6MzQJ5TbKtKW_NzO0;

    invoke-direct {v0, p1}, Lcom/google/firebase/firestore/util/-$$Lambda$AsyncQueue$Y9GO7zO2DX6MzQJ5TbKtKW_NzO0;-><init>(Ljava/lang/Runnable;)V
...
.method public synthetic lambda$runDelayedTasksUntil$6$AsyncQueue(Lcom/google/firebase/firestore/util/AsyncQueue$TimerId;)V
    .locals 3
    ...
    sget-object v1, Lcom/google/firebase/firestore/util/-$$Lambda$AsyncQueue$LFp0J_u3FmHRBJkQ81gizbBvBFo;->INSTANCE:Lcom/google/firebase/firestore/util/-$$Lambda$AsyncQueue$LFp0J_u3FmHRBJkQ81gizbBvBFo;
...
.method public panic(Ljava/lang/Throwable;)V
    ...
    new-instance v1, Lcom/google/firebase/firestore/util/-$$Lambda$AsyncQueue$jx84dqgUsF4ojecSMurRqFLFD1Y;

    invoke-direct {v1, p1}, Lcom/google/firebase/firestore/util/-$$Lambda$AsyncQueue$jx84dqgUsF4ojecSMurRqFLFD1Y;-><init>(Ljava/lang/Throwable;)V
...
.method public runDelayedTasksUntil(Lcom/google/firebase/firestore/util/AsyncQueue$TimerId;)V
    ...
    .line 581
    new-instance v0, Lcom/google/firebase/firestore/util/-$$Lambda$AsyncQueue$59an3r4ApYVN3kcSnIwscxtl1AA;

    invoke-direct {v0, p0, p1}, Lcom/google/firebase/firestore/util/-$$Lambda$AsyncQueue$59an3r4ApYVN3kcSnIwscxtl1AA;-><init>(Lcom/google/firebase/firestore/util/AsyncQueue;Lcom/google/firebase/firestore/util/AsyncQueue$TimerId;)V
...
.method public runSync(Ljava/lang/Runnable;)V
    ...
    new-instance v4, Lcom/google/firebase/firestore/util/-$$Lambda$AsyncQueue$noT0zQB_5OfLUL2pW7l8wcztzBs;

    invoke-direct {v4, p1, v3, v0}, Lcom/google/firebase/firestore/util/-$$Lambda$AsyncQueue$noT0zQB_5OfLUL2pW7l8wcztzBs;-><init>(Ljava/lang/Runnable;[Ljava/lang/Throwable;Ljava/util/concurrent/Semaphore;)V
