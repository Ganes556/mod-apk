...
.method public forEachTarget(Lcom/google/firebase/firestore/util/Consumer;)V
    ...
    new-instance v1, Lcom/google/firebase/firestore/local/-$$Lambda$SQLiteTargetCache$H8yJAv7fDfC0tBbpX5OjiOStwMw;

    invoke-direct {v1, p0, p1}, Lcom/google/firebase/firestore/local/-$$Lambda$SQLiteTargetCache$H8yJAv7fDfC0tBbpX5OjiOStwMw;-><init>(Lcom/google/firebase/firestore/local/SQLiteTargetCache;Lcom/google/firebase/firestore/util/Consumer;)V
...
.method public getMatchingKeysForTargetId(I)Lcom/google/firebase/database/collection/ImmutableSortedSet;
    ...
    new-instance v2, Lcom/google/firebase/firestore/local/-$$Lambda$SQLiteTargetCache$-ZfGzeYfQgZnBHFZCnSUlkdAHIA;

    invoke-direct {v2, v0}, Lcom/google/firebase/firestore/local/-$$Lambda$SQLiteTargetCache$-ZfGzeYfQgZnBHFZCnSUlkdAHIA;-><init>(Lcom/google/firebase/firestore/local/SQLiteTargetCache$DocumentKeysHolder;)V
...
.method public getTargetData(Lcom/google/firebase/firestore/core/Target;)Lcom/google/firebase/firestore/local/TargetData;
    ...
    new-instance v3, Lcom/google/firebase/firestore/local/-$$Lambda$SQLiteTargetCache$BfQyrYem3i8SmjNDJjlW0-2_IRU;

    invoke-direct {v3, p0, p1, v1}, Lcom/google/firebase/firestore/local/-$$Lambda$SQLiteTargetCache$BfQyrYem3i8SmjNDJjlW0-2_IRU;-><init>(Lcom/google/firebase/firestore/local/SQLiteTargetCache;Lcom/google/firebase/firestore/core/Target;Lcom/google/firebase/firestore/local/SQLiteTargetCache$TargetDataHolder;)V
...
.method public synthetic lambda$forEachTarget$1$SQLiteTargetCache(Lcom/google/firebase/firestore/util/Consumer;Landroid/database/Cursor;)V
    .locals 1
...
.method public synthetic lambda$getTargetData$3$SQLiteTargetCache(Lcom/google/firebase/firestore/core/Target;Lcom/google/firebase/firestore/local/SQLiteTargetCache$TargetDataHolder;Landroid/database/Cursor;)V
    .locals 2
    .param p1, "target"    # Lcom/google/firebase/firestore/core/Target;
...
.method public synthetic lambda$removeQueries$2$SQLiteTargetCache(Landroid/util/SparseArray;[ILandroid/database/Cursor;)V
    .locals 3
...
.method public synthetic lambda$start$0$SQLiteTargetCache(Landroid/database/Cursor;)V
    .locals 5
    .param p1, "row"    # Landroid/database/Cursor;
...
.method removeQueries(JLandroid/util/SparseArray;)I
    ...
    new-instance v2, Lcom/google/firebase/firestore/local/-$$Lambda$SQLiteTargetCache$Yqqel9pMLvTdRWvQGR4tU0flww8;

    invoke-direct {v2, p0, p3, v1}, Lcom/google/firebase/firestore/local/-$$Lambda$SQLiteTargetCache$Yqqel9pMLvTdRWvQGR4tU0flww8;-><init>(Lcom/google/firebase/firestore/local/SQLiteTargetCache;Landroid/util/SparseArray;[I)V
...
.method start()V
    ...
    new-instance v1, Lcom/google/firebase/firestore/local/-$$Lambda$SQLiteTargetCache$vQY0jO1WTa0HkzeOXZt7M6zQLsY;

    invoke-direct {v1, p0}, Lcom/google/firebase/firestore/local/-$$Lambda$SQLiteTargetCache$vQY0jO1WTa0HkzeOXZt7M6zQLsY;-><init>(Lcom/google/firebase/firestore/local/SQLiteTargetCache;)V
